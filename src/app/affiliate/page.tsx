...
/* ── FAQ data ── */
const faqs = [
  { q: "How much can I earn per referral?", a: "You earn 10% of the referred client's first invoice. Since our plans range from $97 to custom enterprise pricing, a single referral can net you $10 to well over $500." },
