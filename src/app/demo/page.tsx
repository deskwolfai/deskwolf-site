...
import OutboundDemoForm from "./OutboundDemoForm";
...
export default function DemoPage() {
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative z-[2] min-h-screen flex items-center pt-[110px] pb-[60px]">
        ...
        <div className="max-w-[1440px] mx-auto px-[clamp(16px,3.5vw,40px)] w-full">
          ...
          <div className="max-w-[820px] mx-auto text-center mb-12">
            ...
            <p className="text-[clamp(16px,1.7vw,19px)] text-text-2 max-w-[680px] mx-auto opacity-0 animate-fade-up" style={{ animationDelay: "0.25s" }}>
              Three ways to get started. Call Angel directly, have her call you, or skip the AI and book a discovery call with our founder.
            </p>
          </div>

          {/* ──── THE 3-OPTION HUB ──── */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-[1240px] mx-auto opacity-0 animate-fade-up" style={{ animationDelay: "0.35s" }}>
            ...
            {/* ─── 2. HAVE ANGEL CALL YOU ─── */}
            <a
              href="#call-me-now"
              className="group relative block no-underline"
            >
              <div className="absolute -inset-[1px] rounded-[28px] bg-gradient-to-br from-brand-amber/50 via-orange-500/50 to-brand-amber/50 opacity-0 group-hover:opacity-100 blur-[2px] transition-opacity duration-300" />
              <div className="relative h-full bg-[rgba(12,14,20,0.85)] backdrop-blur-[24px] border border-white/[0.10] rounded-[28px] p-[clamp(28px,3.5vw,40px)] transition-all duration-300 group-hover:border-white/[0.18] group-hover:-translate-y-1 group-hover:shadow-[0_24px_64px_-12px_rgba(245,158,11,0.3)]">
                <div className="font-mono text-[10px] tracking-[0.12em] uppercase text-brand-amber mb-5">Option 2 · Get a Callback</div>

                <div className="w-[80px] h-[80px] rounded-[22px] bg-gradient-to-br from-brand-amber to-orange-500 flex items-center justify-center mb-6 shadow-[0_8px_28px_rgba(245,158,11,0.35)]" style={{ animation: "ringPulse 2.4s ease-out infinite" }}>
                ...
                <h3 className="text-[26px] font-extrabold text-text mb-3 leading-tight">Have Angel call you</h3>
                <p className="text-[14px] text-text-3 leading-relaxed mb-6">
                  Drop your number. Angel dials you back in seconds. Perfect if you can&rsquo;t pick up the phone right now or want to test her outbound flow.
                </p>

                <div className="text-[16px] font-bold text-text-2 mb-5">
                  60-second AI demo · Free
                </div>

                <div className="flex items-center justify-center gap-2.5 w-full py-3.5 px-6 rounded-[100px] bg-gradient-to-r from-brand-amber to-orange-500 text-white font-semibold text-[15px] shadow-[0_8px_24px_rgba(245,158,11,0.3)] transition-all duration-300 group-hover:shadow-[0_12px_32px_rgba(245,158,11,0.4)]">
                  Drop your number
            ...
            >
              ...
              <div className="relative h-full bg-[rgba(12,14,20,0.85)] backdrop-blur-[24px] border border-white/[0.10] rounded-[28px] p-[clamp(28px,3.5vw,40px)] transition-all duration-300 group-hover:border-white/[0.18] group-hover:-translate-y-1 group-hover:shadow-[0_24px_64px_-12px_rgba(139,92,246,0.3)]">
                <div className="font-mono text-[10px] tracking-[0.12em] uppercase text-brand-purple mb-5">Option 3 · Talk to a Human</div>
      ...
      {/* ════════════ HAVE ANGEL CALL YOU (OUTBOUND FORM) ════════════ */}
      <section id="call-me-now" className="relative z-[2] py-[100px] scroll-mt-[100px]">
        <div className="max-w-[720px] mx-auto px-[clamp(16px,3.5vw,40px)]">
          <div className="text-center max-w-[560px] mx-auto rv mb-10">
            <span className="font-mono font-medium text-[11px] tracking-[0.1em] uppercase text-brand-amber">Get a Callback from Angel</span>
            <h2 className="text-[clamp(28px,3.8vw,42px)] mt-2 mb-3">
              Drop your number.{" "}
              <span className="bg-gradient-to-r from-brand-amber via-orange-500 to-brand-amber bg-clip-text text-transparent">
                She&rsquo;ll call you.
              </span>
            </h2>
            <p className="text-[16px] text-text-2">
              Fill out the form and Angel will dial your number within seconds. One-time AI demo call &mdash; no follow-up texts, no list, no nonsense.
            </p>
          </div>

          <div className="relative rv">
            <div className="absolute -inset-[2px] rounded-[28px] bg-gradient-to-br from-brand-amber via-orange-500 to-brand-amber opacity-25 blur-[3px]" />
            <div className="relative bg-[rgba(12,14,20,0.92)] backdrop-blur-[40px] border border-white/[0.12] rounded-[28px] p-[clamp(24px,3vw,40px)] shadow-[0_40px_100px_-20px_rgba(245,158,11,0.25)]">
              <OutboundDemoForm />
            </div>
          </div>
          ...
          <div className="text-center mt-8 rv">
            <p className="text-sm text-text-3">
              Prefer to dial out instead?{" "}
              <a href="tel:+19097570141" className="text-brand-cyan no-underline hover:underline">
                Call (909) 757-0141
              </a>
            </p>
          </div>
